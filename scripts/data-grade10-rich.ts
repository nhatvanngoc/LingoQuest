import { Grade10VocabItem } from "../src/lib/curriculum/grade10-data";

export const RICH_VOCAB_GRADE10: Record<string, Grade10VocabItem[]> = {
  "unit-1-family-life": [
    {
      id: "v10-breadwinner",
      word: "breadwinner",
    ...
    },
    {
      ...
      ipa: "/ˌhevi ˈlɪftɪŋ/",
      audioUrl: "https://img.loigiaihay.com/picture/2021/1103/heavy-lifting.mp3",
      imageUrl: "https://images.unsplash.com/photo-1534438327276-14e5300c3a48?auto=format&fit=crop&w=800&q=80",
      exampleEn: "My brother usually does the heavy lifting around the house.",
      exampleVi: "Anh trai tôi thường làm các việc nặng nhọc trong nhà.",
    ...
    },
    {
      ...
      word: "groceries",
      partOfSpeech: "noun",
      meaningVi: "thực phẩm và hàng tạp hóa",
      ipa: "/ˈɡrəʊsəriz/",
      audioUrl: "https://img.loigiaihay.com/picture/2021/1103/groceries.mp3",
      imageUrl: "https://images.unsplash.com/photo-1542838132-92c53300491e?auto=format&fit=crop&w=800&q=80",
      exampleEn: "Mom asked me to shop for groceries after school.",
      exampleVi: "Mẹ dặn tôi đi mua hàng thực phẩm sau giờ tan trường.",
      collocations: ["buy groceries", "shop for groceries", "grocery bag"]
    },
    {
      id: "v10-laundry",
      word: "laundry",
      ...
      collocations: ["do the laundry", "laundry detergent", "clean laundry"]
    },
    {
      id: "v10-gratitude",
      word: "gratitude",
      partOfSpeech: "noun",
      meaningVi: "lòng biết ơn, sự trân trọng",
      ipa: "/ˈɡrætɪtjuːd/",
      ...
      exampleEn: "Children should express gratitude towards their parents' sacrifices.",
      exampleVi: "Con cái nên bày tỏ lòng biết ơn đối với sự hy sinh của cha mẹ.",
      collocations: ["express gratitude", "feel gratitude", "deep gratitude"]
    },
    {
      id: "v10-strengthen",
      word: "strengthen",
      partOfSpeech: "verb",
      meaningVi: "củng cố, thắt chặt, làm mạnh thêm",
      ipa: "/ˈstreŋkθn/",
      ...
      exampleEn: "Having meals together strengthens family bonds.",
      exampleVi: "Cùng nhau ăn cơm giúp thắt chặt tình cảm gắn kết gia đình.",
      collocations: ["strengthen family bonds", "strengthen relationship", "strengthen ties"]
    },
    {
      id: "v10-split",
      word: "split",
      ...
      collocations: ["split the chores", "split the bill", "split evenly"]
    },
    {
      id: "v10-nurture",
      word: "nurture",
      ...
      collocations: ["nurture a child", "nurture talent", "nurture relationship"]
    },
    {
      id: "v10-burden",
      word: "burden",
      ...
      collocations: ["heavy burden", "shoulder the burden", "financial burden"]
    },
    {
      ...
      collocations: ["manage household finances", "budget household finances"]
    }
  ],
  ...
  "unit-2-humans-and-the-environment": [
    {
      ...
      partOfSpeech: "noun phrase",
      meaningVi: "dấu chân carbon (lượng khí thải CO2 cá nhân thải ra)",
      ipa: "/ˌkɑːbən ˈfʊtprɪnt/",
      audioUrl: "https://img.loigiaihay.com/picture/2021/1103/carbon_footprint.mp3",
      exampleEn: "Using public transport is a great way to reduce your carbon footprint.",
      exampleVi: "Sử dụng phương tiện công cộng là cách tuyệt vời để giảm dấu chân carbon của bạn.",
    ...
    },
    {
      ...
      exampleEn: "Consumers are encouraged to purchase eco-friendly products made from bamboo.",
      exampleVi: "Người tiêu dùng được khuyến khích mua các sản phẩm thân thiện môi trường làm từ tre.",
      collocations: ["eco-friendly lifestyle", "eco-friendly products", "eco-friendly packaging"]
    },
    {
      id: "v10-emission",
      word: "emission",
      partOfSpeech: "noun",
      meaningVi: "sự phát thải khí, khí thải",
      ipa: "/iˈmɪʃn/",
      audioUrl: "https://img.loigiaihay.com/picture/2021/1103/emission.mp3",
      exampleEn: "Factories must install filters to reduce hazardous toxic emissions.",
      exampleVi: "Các nhà máy phải lắp đặt bộ lọc để giảm lượng khí phát thải độc hại.",
      collocations: ["cut greenhouse gas emissions", "vehicle emissions", "zero emissions"]
    },
    {
      id: "v10-decompose",
      word: "decompose",
      ...
      collocations: ["decompose naturally", "decompose into soil"]
    },
    {
      id: "v10-replenish",
      word: "replenish",
      ...
      collocations: ["replenish resources", "replenish water supply"]
    },
    {
      id: "v10-sustainable",
      word: "sustainable",
      ...
      collocations: ["sustainable development", "sustainable agriculture", "sustainable future"]
    },
    {
      id: "v10-single-use",
      word: "single-use",
      ...
      collocations: ["single-use plastic", "ban single-use items"]
    },
    {
      id: "v10-green-living",
      word: "green living",
      ...
      collocations: ["adopt green living", "practice green living"]
    },
    {
      id: "v10-solar-panel",
      word: "solar panel",
      ...
      collocations: ["install solar panels", "solar panel efficiency"]
    },
    {
      id: "v10-appliance",
      word: "appliance",
      ...
      collocations: ["household appliance", "electrical appliance", "energy-efficient appliance"]
    }
  ],
  ...
  "unit-3-music": [
    {
      ...
      exampleEn: "The enthusiastic audience cheered loudly when the singer walked onto the stage.",
      exampleVi: "Khán giả nhiệt tình đã reo hò cuồng nhiệt khi ca sĩ bước lên sân khấu.",
      collocations: ["cheering audience", "target audience", "live audience"]
    },
    {
      id: "v10-contestant",
      word: "contestant",
      ...
      collocations: ["talented contestant", "contestant in a competition"]
    },
    {
      id: "v10-instrument",
      word: "instrument",
      ...
      collocations: ["play a musical instrument", "traditional instrument"]
    },
    {
      id: "v10-melody",
      word: "melody",
      ...
      collocations: ["catchy melody", "haunting melody", "sweet melody"]
    },
    {
      id: "v10-release",
      word: "release",
      ...
      collocations: ["release an album", "release a single", "new release"]
    },
    {
      id: "v10-judge",
      word: "judge",
      ...
      collocations: ["panel of judges", "harsh judge", "music competition judge"]
    },
    {
      id: "v10-platinum",
      word: "platinum",
      ...
      collocations: ["go platinum", "platinum record", "platinum album"]
    },
    {
      id: "v10-debut",
      word: "debut",
      ...
      collocations: ["debut album", "make a debut", "debut performance"]
    }
  ],
  ...
  "unit-4-for-a-better-community": [
    {
      ...
      meaningVi: "tình nguyện; tình nguyện viên",
      ipa: "/ˌvɒlənˈtɪə(r)/",
      audioUrl: "https://img.loigiaihay.com/picture/2021/1103/volunteer.mp3",
      exampleEn: "Thousands of high school students volunteer to teach English in rural areas.",
      exampleVi: "Hàng nghìn học sinh cấp ba tình nguyện dạy tiếng Anh ở các vùng nông thôn.",
      collocations: ["volunteer work", "volunteer for charity", "active volunteer"]
    },
    {
      id: "v10-donate",
      word: "donate",
      partOfSpeech: "verb",
      meaningVi: "quyên góp, ủng hộ (tiền, hiện vật)",
      ipa: "/dəʊˈneɪt/",
      audioUrl: "https://img.loigiaihay.com/picture/2021/1103/donate.mp3",
      exampleEn: "Our class donated warm winter clothes and notebooks to poor children.",
      exampleVi: "Lớp chúng tôi đã quyên góp quần áo ấm mùa đông và sách vở cho trẻ em nghèo.",
      collocations: ["donate blood", "donate money to charity", "generous donation"]
    },
    {
      ...
      collocations: ["underprivileged background", "underprivileged children"]
    },
    {
      id: "v10-non-profit",
      word: "non-profit",
      ...
      collocations: ["non-profit organization (NGO)", "non-profit sector"]
    },
    {
      id: "v10-dedicate",
      word: "dedicate",
      ...
      collocations: ["dedicate time to", "dedicate life to charity"]
    },
    {
      id: "v10-remote-area",
      word: "remote area",
      ...
      collocations: ["live in a remote area", "access to remote areas"]
    },
    {
      id: "v10-contribution",
      word: "contribution",
      ...
      collocations: ["make a significant contribution", "valuable contribution"]
    }
  ],
  ...
  "unit-5-inventions": [
    {
      ...
      audioUrl: "https://img.loigiaihay.com/picture/2021/1103/ai.mp3",
      exampleEn: "Artificial intelligence is revolutionizing the way students learn foreign languages.",
      exampleVi: "Trí tuệ nhân tạo đang tạo nên cuộc cách mạng trong cách học sinh học ngoại ngữ.",
      collocations: ["AI-powered tool", "develop artificial intelligence", "generative AI"]
    },
    {
      id: "v10-breakthrough",
      word: "breakthrough",
      ...
      collocations: ["technological breakthrough", "major breakthrough", "scientific breakthrough"]
    },
    {
      id: "v10-portable",
      word: "portable",
      partOfSpeech: "adjective",
      meaningVi: "có thể mang theo, xách tay, nhỏ gọn",
      ipa: "/ˈpɔːtəbl/",
      audioUrl: "https://img.loigiaihay.com/picture/2021/1103/portable.mp3",
      exampleEn: "Laptops and tablets are portable devices that facilitate remote working.",
      exampleVi: "Máy tính xách tay và máy tính bảng là các thiết bị di động nhỏ gọn tạo thuận lợi cho làm việc từ xa.",
      collocations: ["portable device", "portable charger", "highly portable"]
    },
    {
      id: "v10-patent",
      word: "patent",
      ...
      collocations: ["apply for a patent", "patent an invention", "patent protection"]
    },
    {
      id: "v10-3d-printer",
      word: "3D printer",
      ...
      collocations: ["use a 3D printer", "3D printing technology"]
    }
  ],
  ...
  "unit-6-gender-equality": [
    {
      ...
      collocations: ["eliminate discrimination", "eliminate poverty", "eliminate bias"]
    },
    {
      id: "v10-wage-gap",
      word: "wage gap",
      ...
      collocations: ["gender wage gap", "close the wage gap", "narrow the wage gap"]
    },
    {
      id: "v10-pioneer",
      word: "pioneer",
      ...
      collocations: ["female pioneer", "pioneer in science", "pioneer a new method"]
    },
    {
    ...
    },
    {
      ...
      collocations: ["male-dominated field", "male-dominated career"]
    }
  ],
  ...
  "unit-7-viet-nam-and-international-organisations": [
    {
      ...
      collocations: ["multilateral relations", "multilateral agreement", "multilateral diplomacy"]
    },
    {
      id: "v10-peacekeeping",
      word: "peacekeeping",
      ...
      collocations: ["peacekeeping mission", "peacekeeping forces", "UN peacekeeping"]
    },
    {
      id: "v10-integration",
      word: "integration",
      ...
      collocations: ["international integration", "economic integration", "cultural integration"]
    },
    {
      id: "v10-promote",
      word: "promote",
      ...
      collocations: ["promote trade", "promote cultural exchange", "promote peace"]
    }
  ],
  ...
  "unit-8-new-ways-to-learn": [
    {
      ...
      partOfSpeech: "noun phrase",
      meaningVi: "phương pháp học kết hợp (trực tiếp và trực tuyến)",
      ipa: "/ˌblendɪd ˈlɜːnɪŋ/",
      audioUrl: "https://img.loigiaihay.com/picture/2021/1103/blended_learning.mp3",
      exampleEn: "Blended learning allows students to study theoretical lessons online before attending face-to-face classes.",
      exampleVi: "Học kết hợp cho phép học sinh học lý thuyết trực tuyến trước khi tham gia lớp học trực tiếp.",
      collocations: ["adopt blended learning", "blended learning model"]
    },
    {
      id: "v10-self-paced",
      word: "self-paced",
      ...
      collocations: ["self-paced learning", "self-paced course"]
    },
    {
      ...
      collocations: ["collaborative project", "collaborative learning", "collaborative effort"]
    },
    {
      id: "v10-look-up",
      word: "look up",
      ...
      collocations: ["look up a word in the dictionary", "look up information online"]
    }
  ],
  ...
  "unit-9-protecting-the-environment": [
    ...
    },
    {
      ...
      collocations: ["illegal poaching", "anti-poaching patrol", "stop poaching"]
    },
    {
      id: "v10-habitat-loss",
      word: "habitat loss",
      ...
      collocations: ["suffer from habitat loss", "cause habitat loss"]
    },
    {
      id: "v10-sanctuary",
      word: "sanctuary",
  ...
  "unit-10-ecotourism": [
    {
      ...
      collocations: ["popular tourist destination", "ecotourism destination", "holiday destination"]
    },
    {
      ...
      collocations: ["practice sustainable tourism", "principles of sustainable tourism"]
    },
    {
      ...
      collocations: ["native flora and fauna", "rich flora and fauna", "protect flora and fauna"]
    },
    {
      id: "v10-indigenous",
      word: "indigenous",
      ...
      collocations: ["indigenous culture", "indigenous people", "indigenous species"]
    }
  ]
};
