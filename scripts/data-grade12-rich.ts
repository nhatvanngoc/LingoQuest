import { Grade12VocabItem } from "../src/lib/curriculum/grade12-data";

export const RICH_VOCAB_GRADE12: Record<string, Grade12VocabItem[]> = {
  "unit-1-life-stories-we-admire": [
    {
      id: "v12-biography",
      word: "biography",
      partOfSpeech: "noun",
      meaningVi: "tiểu sử, truyện danh nhân cuộc đời",
      ipa: "/baɪˈɒɡrəfi/",
      audioUrl: "https://img.loigiaihay.com/picture/2021/1103/biography.mp3",
      imageUrl: "https://images.unsplash.com/photo-1457369804613-52c61a468e7d?auto=format&fit=crop&w=800&q=80",
      exampleEn: "Reading biographies of great inventors inspires students to pursue their passions.",
      exampleVi: "Đọc tiểu sử của các nhà phát minh vĩ đại truyền cảm hứng cho học sinh theo đuổi đam mê.",
    ...
    },
    {
      ...
      word: "perseverance",
      partOfSpeech: "noun",
      meaningVi: "sự kiên trì, bền chí không bỏ cuộc",
      ipa: "/ˌpɜːsɪˈvɪərəns/",
      audioUrl: "https://img.loigiaihay.com/picture/2021/1103/perseverance.mp3",
      exampleEn: "Through sheer perseverance and hard work, she overcame poverty to become a surgeon.",
      exampleVi: "Bằng sự kiên trì bền bỉ và nỗ lực chăm chỉ, cô ấy đã vượt qua nghèo khó để trở thành một bác sĩ phẫu thuật.",
      collocations: ["sheer perseverance", "demonstrate perseverance", "reward of perseverance"]
    },
    {
      id: "v12-visionary",
      word: "visionary",
      ...
      collocations: ["visionary leader", "visionary thinker", "visionary ideas"]
    },
    {
      id: "v12-humble",
      word: "humble",
      ...
      collocations: ["humble beginnings", "humble lifestyle", "remain humble"]
    },
    {
      id: "v12-dedicated",
      word: "dedicated",
      partOfSpeech: "adjective",
      meaningVi: "tận tụy, cống hiến hết lòng",
      ipa: "/ˈdedɪkeɪtɪd/",
      audioUrl: "https://img.loigiaihay.com/picture/2021/1103/dedicated.mp3",
      exampleEn: "Dr. Alexandre Yersin was deeply dedicated to curing tropical diseases in Viet Nam.",
      exampleVi: "Bác sĩ Alexandre Yersin đã hết lòng tận tụy chữa trị các bệnh nhiệt đới tại Việt Nam.",
      collocations: ["dedicated to the cause", "dedicated teacher", "highly dedicated"]
    },
    {
      id: "v12-resilience",
      word: "resilience",
      ...
      collocations: ["remarkable resilience", "build resilience", "mental resilience"]
    },
    {
      id: "v12-legacy",
      word: "legacy",
      ...
      collocations: ["leave a lasting legacy", "cultural legacy", "historical legacy"]
    }
  ],
  ...
  "unit-2-a-multicultural-world": [
    {
      ...
      collocations: ["preserve cultural heritage", "intangible cultural heritage", "rich cultural heritage"]
    },
    {
      id: "v12-assimilate",
      word: "assimilate",
      ...
      collocations: ["assimilate into culture", "cultural assimilation"]
    },
    {
      ...
      collocations: ["become a global citizen", "responsible global citizen"]
    },
    {
    ...
    },
    {
      ...
      collocations: ["table etiquette", "business etiquette", "social etiquette"]
    }
  ],
  ...
  "unit-3-green-living": [
    {
      ...
      audioUrl: "https://img.loigiaihay.com/picture/2021/1103/biodegradable.mp3",
      exampleEn: "Using biodegradable packaging helps stop microplastic accumulation in oceans.",
      exampleVi: "Sử dụng bao bì tự phân hủy sinh học giúp ngăn chặn sự tích tụ hạt vi nhựa trong đại dương.",
      collocations: ["biodegradable waste", "biodegradable material", "biodegradable plastic"]
    },
    {
      id: "v12-zero-waste",
      word: "zero-waste",
      ...
      collocations: ["zero-waste lifestyle", "zero-waste movement", "zero-waste shop"]
    },
    {
    ...
    },
    {
      ...
      collocations: ["invest in renewable energy", "sources of renewable energy"]
    },
    {
      ...
      collocations: ["carbon-neutral goal", "achieve carbon-neutral status"]
    }
  ],
  ...
  "unit-4-urbanisation": [
    {
      ...
      word: "infrastructure",
      partOfSpeech: "noun",
      meaningVi: "cơ sở hạ tầng (giao thông, điện, nước, y tế)",
      ipa: "/ˈɪnfrəstrʌktʃə(r)/",
      audioUrl: "https://img.loigiaihay.com/picture/2021/1103/infrastructure.mp3",
      exampleEn: "Rapid urbanisation strains old urban infrastructure like drainage systems and bridges.",
      exampleVi: "Đô thị hóa nhanh chóng gây áp lực lên cơ sở hạ tầng đô thị cũ như hệ thống thoát nước và cầu đường.",
      collocations: ["transport infrastructure", "upgrade infrastructure", "modern infrastructure"]
    },
    {
      ...
      collocations: ["suffer from overpopulation", "problem of overpopulation"]
    },
    {
      id: "v12-congestion",
      word: "congestion",
      ...
      collocations: ["traffic congestion", "ease congestion", "heavy congestion"]
    },
    {
      id: "v12-urban-sprawl",
      word: "urban sprawl",
      ...
      collocations: ["control urban sprawl", "consequences of urban sprawl"]
    },
    {
      id: "v12-megacity",
      word: "megacity",
      ...
      ipa: "/ˈmeɡəsɪti/",
      audioUrl: "https://img.loigiaihay.com/picture/2021/1103/megacity.mp3",
      exampleEn: "Tokyo, Shanghai, and New York are prominent examples of thriving global megacities.",
      exampleVi: "Tokyo, Thượng Hải và New York là những ví dụ nổi bật về các siêu đô thị toàn cầu phồn thịnh.",
      collocations: ["growing megacity", "megacity challenges"]
    }
  ],
  ...
  "unit-5-the-world-of-work": [
    {
      ...
      word: "internship",
      partOfSpeech: "noun",
      meaningVi: "kỳ thực tập việc làm",
      ipa: "/ˈɪntɜːnʃɪp/",
      audioUrl: "https://img.loigiaihay.com/picture/2021/1103/internship.mp3",
      exampleEn: "Completing a summer internship provides invaluable real-world workplace experience.",
      exampleVi: "Hoàn thành một kỳ thực tập mùa hè mang lại kinh nghiệm làm việc thực tế vô giá.",
      collocations: ["paid internship", "apply for an internship", "internship opportunity"]
    },
    {
      id: "v12-soft-skills",
      word: "soft skills",
      ...
      collocations: ["develop soft skills", "essential soft skills", "interpersonal soft skills"]
    },
    {
      id: "v12-probation",
      word: "probation",
      ...
      collocations: ["probation period", "pass probation", "on probation"]
    },
    {
  ...
  "unit-6-artificial-intelligence": [
    {
      ...
      collocations: ["machine learning model", "deep machine learning", "apply machine learning"]
    },
    {
      id: "v12-automation",
      word: "automation",
      partOfSpeech: "noun",
      meaningVi: "tự động hóa quy trình",
      ipa: "/ˌɔːtəˈmeɪʃn/",
      audioUrl: "https://img.loigiaihay.com/picture/2021/1103/automation.mp3",
      exampleEn: "Factory automation increases output speed while minimizing human operational errors.",
      exampleVi: "Tự động hóa nhà máy tăng tốc độ sản lượng trong khi giảm thiểu tối đa sai sót thao tác của con người.",
      collocations: ["process automation", "workplace automation", "industrial automation"]
    },
    {
      id: "v12-humanoid",
      word: "humanoid",
      ...
      collocations: ["humanoid robot", "humanoid features"]
    },
    {
      ...
      collocations: ["raise ethical concerns", "address ethical concerns"]
    }
  ],
  ...
  "unit-7-the-world-of-mass-media": [
    {
      ...
      word: "sensationalism",
      partOfSpeech: "noun",
      meaningVi: "xu hướng giật gân, câu view rẻ tiền của báo chí",
      ipa: "/senˈseɪʃənəlɪzəm/",
      audioUrl: "https://img.loigiaihay.com/picture/2021/1103/sensationalism.mp3",
      exampleEn: "Quality journalism avoids cheap sensationalism and focuses on verified facts.",
      exampleVi: "Báo chí chất lượng cao tránh xu hướng giật gân rẻ tiền và tập trung vào các sự thật được kiểm chứng.",
      collocations: ["media sensationalism", "headline sensationalism"]
    },
    {
      ...
      collocations: ["teach media literacy", "critical media literacy"]
    },
    {
      id: "v12-misinformation",
      word: "misinformation",
      partOfSpeech: "noun",
      meaningVi: "thông tin sai lệch, thất thiệt",
      ipa: "/ˌmɪsˌɪnfəˈmeɪʃn/",
      audioUrl: "https://img.loigiaihay.com/picture/2021/1103/misinformation.mp3",
      exampleEn: "Social media algorithms can unintentionally accelerate the spread of medical misinformation.",
      exampleVi: "Thuật toán mạng xã hội có thể vô tình đẩy nhanh sự lan truyền của thông tin y tế sai lệch.",
      collocations: ["spread misinformation", "combat misinformation", "debunk misinformation"]
    },
    {
      id: "v12-credibility",
      word: "credibility",
      partOfSpeech: "noun",
      meaningVi: "độ tin cậy, uy tín",
      ipa: "/ˌkredəˈbɪləti/",
      audioUrl: "https://img.loigiaihay.com/picture/2021/1103/credibility.mp3",
      exampleEn: "Publishing unverified rumors severely damages a news outlet's credibility.",
      exampleVi: "Xuất bản tin đồn chưa được kiểm chứng sẽ hủy hoại nghiêm trọng uy tín của một tòa soạn tin tức.",
  ...
  "unit-8-wildlife-conservation": [
    {
      ...
      collocations: ["global biodiversity hotspot", "protect biodiversity hotspots"]
    },
    {
      ...
      collocations: ["reintroduction program", "species reintroduction"]
    },
    {
      ...
      collocations: ["classified as extinct in the wild", "threat of extinction"]
    },
    {
      ...
      collocations: ["combat wildlife trafficking", "illicit wildlife trafficking"]
    }
  ],
  ...
  "unit-9-career-paths": [
    {
      ...
      collocations: ["career trajectory", "upward trajectory", "professional trajectory"]
    },
    {
      id: "v12-apprenticeship",
      word: "apprenticeship",
      partOfSpeech: "noun",
      meaningVi: "chế độ học nghề (vừa học vừa làm có lương)",
      ipa: "/əˈprentɪsʃɪp/",
      audioUrl: "https://img.loigiaihay.com/picture/2021/1103/apprenticeship.mp3",
      exampleEn: "Many European school leavers choose an apprenticeship rather than going straight to university.",
      exampleVi: "Nhiều học sinh tốt nghiệp phổ thông châu Âu chọn học nghề thay vì vào thẳng đại học.",
      collocations: ["serve an apprenticeship", "apprenticeship program", "complete an apprenticeship"]
    },
    {
      ...
      collocations: ["stepping stone to success", "serve as a stepping stone"]
    },
    {
      ...
      collocations: ["job shadowing opportunity", "conduct job shadowing"]
    }
  ],
  ...
  "unit-10-lifelong-learning": [
    ...
    },
    {
      ...
      collocations: ["upskill workforce", "opportunity to upskill", "upskilling program"]
    },
    {
      ...
      collocations: ["broaden intellectual horizons", "travel to broaden horizons"]
    },
    {
      id: "v12-self-directed",
      word: "self-directed",
      partOfSpeech: "adjective",
      meaningVi: "tự định hướng, chủ động làm chủ việc học",
      ipa: "/ˌself daɪˈrektɪd/",
      audioUrl: "https://img.loigiaihay.com/picture/2021/1103/self_directed.mp3",
      exampleEn: "Successful lifelong learners possess strong self-directed study habits and deep curiosity.",
      exampleVi: "Những người học tập suốt đời thành công đều sở hữu thói quen tự định hướng việc học và tính hiếu tri sâu sắc.",
      collocations: ["self-directed learning", "self-directed student"]
    }
  ]
};
