  ...
  return (
    <div
      style={{
        ...
        fontSize: value.length > 3 ? 740 : 880,
        lineHeight: 1,
    ...
    <AbsoluteFill style={{ background: C.ink }}>
      ...
      >
        <div style={{ display: 'flex', gap: 14, alignItems: 'center' }}>
          ...
          <span style={{ fontFamily: "'JetBrains Mono', monospace", fontSize: 19, lineHeight: 1.6, letterSpacing: '0.16em', color: C.line, fontWeight: 700 }}>
            REF: HARNESS — BLUEPRINT_EDITION
          </span>
          <span style={{ fontFamily: "'JetBrains Mono', monospace", fontSize: 18, lineHeight: 1.6, letterSpacing: '0.14em', color: C.steel }}>REV 9.5 / 2026-09-04</span>
        </div>
        <div style={{ fontFamily: "'JetBrains Mono', monospace", fontSize: 18, letterSpacing: '0.14em', color: C.cyan, fontWeight: 700, lineHeight: 1.6 }}>
      ...
      >
        ...
        >
          <span style={{ fontFamily: "'JetBrains Mono', monospace", fontSize: 22, lineHeight: 1.6, letterSpacing: '0.12em', color: C.line, fontWeight: 700 }}>
          ...
          <span style={{ width: 4, height: 4, background: C.steel, borderRadius: 999 }} />
          <span style={{ fontFamily: "'Inter', system-ui, sans-serif", fontSize: 22, letterSpacing: '0.08em', color: C.cyan, fontWeight: 700 }}>
            PERSISTENT PROFILE
          </span>
        </div>
        <div
      ...
      >
        {[
          ...
          { k: 'TYPE', v: 'INSTRUMENT SERIF 154PX / JETBRAINS MONO 22PX' },
          { k: 'GRID', v: 'DOTS 24PX / RAIL 72PX / 1920×1080' },
        ].map((s) => (
          <div key={s.k} style={{ borderLeft: '2px solid rgba(232,240,254,0.14)', paddingLeft: 12 }}>
            <div style={{ fontFamily: "'JetBrains Mono', monospace", fontSize: 15, lineHeight: 1.6, letterSpacing: '0.18em', color: C.steel }}>{s.k}</div>
            <div style={{ fontFamily: "'JetBrains Mono', monospace", fontSize: 18, lineHeight: 1.6, letterSpacing: '0.08em', color: 'rgba(232,240,254,0.72)', marginTop: 4 }}>{s.v}</div>,
                              lineHeight: 1.6,
          </div>
        ))}
      </div>
...
const Scene02: React.FC = () => {
  ...
  return (
    <AbsoluteFill style={{ background: C.ink }}>
      ...
      >
        <div style={{ display: 'flex', gap: 14, alignItems: 'center' }}>
          <div style={{ fontFamily: "'JetBrains Mono', monospace", fontSize: 19, lineHeight: 1.6, letterSpacing: '0.18em', color: '#0A0F1E', fontWeight: 900, background: C.hazard, padding: '4px 8px' }}>
            02 — MCPs
          </div>
          <span style={{ fontFamily: "'Instrument Serif', serif", fontSize: 38, letterSpacing: '-0.02em', color: C.line }}>17 MCP SERVERS</span>
          <span style={{ fontFamily: "'JetBrains Mono', monospace", fontSize: 18, lineHeight: 1.6, letterSpacing: '0.14em', color: C.steel }}>WIRED · SIGNAL PULSE</span>
        </div>
        <div style={{ fontFamily: "'JetBrains Mono', monospace", fontSize: 18, letterSpacing: '0.12em', color: C.cyan, lineHeight: 1.6 }}>
      ...
      >
        ...
        {MCP_LIST.map((_, i) => {
          ...
          const y = 154 + i * 50; // spread 17 across 156→ 932 approx
      ...
      >
        <div style={{ fontFamily: "'JetBrains Mono', monospace", fontSize: 15, lineHeight: 1.6, letterSpacing: '0.18em', color: C.cyan, fontWeight: 700 }}>HARNESS CORE</div>
        <div style={{ fontFamily: "'JetBrains Mono', monospace", fontSize: 18, lineHeight: 1.6, letterSpacing: '0.12em', color: C.line, fontWeight: 700 }}>17 SERVERS · WIRED</div>,
                          lineHeight: 1.6,
        ...
        return (
          ...
          >
            ...
            <div style={{ marginLeft: 'auto', display: 'flex', alignItems: 'center', gap: 6 }}>
              ...
              />
              <span style={{ fontFamily: "'JetBrains Mono', monospace", fontSize: 14, lineHeight: 1.6, letterSpacing: '0.12em', color: C.steel }}>●</span>
            </div>
          </div>
        );
      })}
      ...
      >
        <div style={{ display: 'flex', gap: 8, alignItems: 'center' }}>
          ...
          <span style={{ fontFamily: "'JetBrains Mono', monospace", fontSize: 18, lineHeight: 1.6, letterSpacing: '0.12em', color: C.line }}>SIGNAL PULSE</span>
        </div>
        <div style={{ width: 1, height: 14, background: 'rgba(232,240,254,0.12)' }} />
        <div style={{ display: 'flex', gap: 8, alignItems: 'center' }}>
          <div style={{ width: 14, height: 1, background: 'rgba(232,240,254,0.22)' }} />
          <span style={{ fontFamily: "'JetBrains Mono', monospace", fontSize: 18, lineHeight: 1.6, letterSpacing: '0.12em', color: C.steel }}>BLUEPRINT WIRE</span>
        </div>
        <div style={{ width: 1, height: 14, background: 'rgba(232,240,254,0.12)' }} />
        <span style={{ fontFamily: "'JetBrains Mono', monospace", fontSize: 18, lineHeight: 1.6, letterSpacing: '0.14em', color: 'rgba(232,240,254,0.5)' }}>
    ...
    <AbsoluteFill style={{ background: C.ink }}>
      ...
      >
        <div style={{ display: 'flex', gap: 14, alignItems: 'center' }}>
          ...
          <span style={{ fontFamily: "'Instrument Serif', serif", fontSize: 38, letterSpacing: '-0.02em', color: C.line }}>31 SKILLS · 7 GROUPS + 3 NEW</span>
        </div>
        <div style={{ fontFamily: "'JetBrains Mono', monospace", fontSize: 18, lineHeight: 1.6, letterSpacing: '0.12em', color: C.hazard, fontWeight: 700, border: '1px solid rgba(255,214,10,0.4)', padding: '5px 10px', background: 'rgba(255,214,10,0.08)' }}>
      ...
      >
        <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: 4 }}>
          <span style={{ fontFamily: "'JetBrains Mono', monospace", fontSize: 18, lineHeight: 1.6, letterSpacing: '0.18em', color: C.cyan, fontWeight: 700 }}>NEW · 2026-09-04</span>
          <span style={{ fontFamily: "'JetBrains Mono', monospace", fontSize: 18, lineHeight: 1.6, letterSpacing: '0.14em', color: C.steel }}>via npx skills add</span>
        </div>
        ...
        <div style={{ position: 'relative', flex: 1, display: 'flex', flexDirection: 'column', gap: 12 }}>
            ...
            return (
              ...
              >
                <div style={{ display: 'flex', alignItems: 'center', gap: 10 }}>
                  ...
                  <span style={{ fontFamily: "'JetBrains Mono', monospace", fontSize: 22, lineHeight: 1.6, letterSpacing: '0.04em', color: C.line, fontWeight: 800 }}>{s.name}</span>
                  <span
                    style={{
                      marginLeft: 'auto',
                      fontFamily: "'JetBrains Mono', monospace",
                ...
                <div style={{ fontFamily: "'Inter', system-ui, sans-serif", fontSize: 20, letterSpacing: '0.02em', color: 'rgba(232,240,254,0.62)', lineHeight: 1.4 }}>{s.desc}</div>
                <div style={{ display: 'flex', gap: 6, alignItems: 'center', marginTop: 2 }}>
                  <div style={{ width: 6, height: 6, background: active ? C.hazard : C.steel, borderRadius: 999 }} />
                  <span style={{ fontFamily: "'JetBrains Mono', monospace", fontSize: 15, lineHeight: 1.6, letterSpacing: '0.14em', color: active ? C.hazard : C.steel, fontWeight: 700 }}>
                    {active ? '● ACTIVE' : '○ READY'}
                  </span>
                  <span style={{ fontFamily: "'JetBrains Mono', monospace", fontSize: 15, lineHeight: 1.6, letterSpacing: '0.10em', color: 'rgba(124,141,166,0.5)' }}>
          ...
          >
            <span style={{ fontFamily: "'JetBrains Mono', monospace", fontSize: 18, lineHeight: 1.6, letterSpacing: '0.14em', color: C.steel }}>TOTAL 31 SKILLS · 28 EXISTING + 3 NEW</span>
            <span style={{ fontFamily: "'JetBrains Mono', monospace", fontSize: 18, lineHeight: 1.6, letterSpacing: '0.14em', color: C.cyan, fontWeight: 700 }}>#FFD60A — HAZARD</span>
          </div>
        </div>
      </div>
      ...
      >
        <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: 12 }}>
          <span style={{ fontFamily: "'JetBrains Mono', monospace", fontSize: 18, lineHeight: 1.6, letterSpacing: '0.18em', color: 'rgba(232,240,254,0.42)', fontWeight: 700 }}>LEGACY SKILLS — 28 — MUTED</span>
          <span style={{ fontFamily: "'JetBrains Mono', monospace", fontSize: 15, lineHeight: 1.6, letterSpacing: '0.12em', color: 'rgba(124,141,166,0.5)' }}>GROUPS: 7 · RESEARCH / VIDEO / OFFICE / DESIGN / CAD / QA / FRONTEND</span>
        </div>

        {/* columns */}
        <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr 1fr', gap: 12, opacity: 0.72 }}>
          {OLD_SKILLS.map((name, i) => {
            ...
            return (
              ...
              >
                ...
                <span style={{ fontFamily: "'JetBrains Mono', monospace", fontSize: 18, lineHeight: 1.3, letterSpacing: '0.02em', color: 'rgba(232,240,254,0.58)', fontWeight: 500, whiteSpace: 'nowrap', overflow: 'hidden', textOverflow: 'ellipsis' }}>
                  {name}
                </span>
              </div>
            );
...
const Scene04: React.FC = () => {
  ...
  return (
    <AbsoluteFill style={{ background: C.ink }}>
      ...
      >
        <div style={{ display: 'flex', gap: 14, alignItems: 'center' }}>
          <div style={{ fontFamily: "'JetBrains Mono', monospace", fontSize: 19, lineHeight: 1.6, letterSpacing: '0.18em', color: '#fff', fontWeight: 900, background: C.signal, padding: '4px 8px' }}>04 — PROOF</div>
          <span style={{ fontFamily: "'Instrument Serif', serif", fontSize: 38, letterSpacing: '-0.02em', color: C.line }}>PERSISTENT GOOGLE PROFILE</span>
          <span style={{ fontFamily: "'JetBrains Mono', monospace", fontSize: 18, lineHeight: 1.6, letterSpacing: '0.14em', color: C.cyan, border: '1px solid rgba(0,212,255,0.28)', padding: '4px 8px', background: 'rgba(0,212,255,0.08)' }}>LIVE DEMO</span>
        </div>
        <div style={{ fontFamily: "'JetBrains Mono', monospace", fontSize: 18, letterSpacing: '0.12em', color: C.steel, display: 'flex', gap: 10, alignItems: 'center', lineHeight: 1.6 }}>
      ...
      >
        ...
        <div style={{ padding: '22px 28px 18px', borderBottom: '1px solid #e8eaed' }}>
          <div style={{ fontFamily: "'Inter', system-ui, sans-serif", fontSize: 38, fontWeight: 400, color: '#202124', lineHeight: 1.2 }}>
            HARNESS 9.5 — Hồ sơ Persistent Profile
          </div>
          <div style={{ fontFamily: "'Inter', system-ui, sans-serif", fontSize: 22, color: '#5f6368', marginTop: 8, lineHeight: 1.5 }}>
            Biểu mẫu đã demo thật · Dữ liệu được lưu trên Google Account và tự động điền lại khi mở lại.
          </div>
          <div style={{ fontFamily: "'JetBrains Mono', monospace", fontSize: 18, lineHeight: 1.6, letterSpacing: '0.08em', color: '#1a73e8', marginTop: 10, background: '#e8f0fe', padding: '6px 10px', display: 'inline-block', borderRadius: 16 }}>
        ...
        <div style={{ padding: '18px 28px', display: 'flex', flexDirection: 'column', gap: 16, flex: 1 }}>
          {[
            ...
            return (
              ...
              >
                <div style={{ fontFamily: "'Inter', system-ui, sans-serif", fontSize: 20, fontWeight: 600, letterSpacing: '0.02em', color: filled ? '#1a73e8' : '#5f6368', marginBottom: 8 }}>{f.label}</div>
                <div style={{ fontFamily: "'JetBrains Mono', monospace", fontSize: 22, lineHeight: 1.6, color: '#202124', minHeight: 18, display: 'flex', alignItems: 'center', gap: 2 }}>
                  {filled ? (
                    <>
                      <span>{txt}</span>
                ...
                {filled && (
                  <div style={{ position: 'absolute', right: 12, top: 14, width: 18, height: 18, borderRadius: 999, background: '#1a73e8', display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
                    <span style={{ color: '#fff', fontSize: 19, fontWeight: 800 }}>✓</span>
                  </div>
                )}
              </div>
            );
          ...
          <div style={{ display: 'flex', gap: 12, marginTop: 6 }}>
            <div style={{ background: '#1a73e8', color: '#fff', fontFamily: "'Inter', system-ui, sans-serif", fontSize: 22, fontWeight: 600, padding: '10px 22px', borderRadius: 16 }}>Gửi</div>
            <div style={{ color: '#5f6368', fontFamily: "'Inter', system-ui, sans-serif", fontSize: 20, display: 'flex', alignItems: 'center' }}>Xóa hết câu trả lời</div>
          </div>
        </div>
      </div>
      ...
      >
        ...
        >
          <div style={{ display: 'flex', gap: 10, alignItems: 'center' }}>
            ...
            <span style={{ fontFamily: "'JetBrains Mono', monospace", fontSize: 18, lineHeight: 1.6, letterSpacing: '0.18em', color: C.cyan, fontWeight: 700 }}>FIELD VALUES — DEMO THẬT</span>
            <span style={{ marginLeft: 'auto', fontFamily: "'JetBrains Mono', monospace", fontSize: 18, lineHeight: 1.6, letterSpacing: '0.12em', color: C.steel }}>AUTO-FILL · PERSISTENT</span>
          </div>
          ...
          <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 10 }}>
            {[
              ...
              <div key={x.k} style={{ background: 'rgba(10,15,30,0.9)', border: '1px solid rgba(232,240,254,0.08)', padding: '10px 12px' }}>
                <div style={{ fontFamily: "'JetBrains Mono', monospace", fontSize: 15, lineHeight: 1.6, letterSpacing: '0.14em', color: C.steel }}>{x.k}</div>
                <div style={{ fontFamily: "'JetBrains Mono', monospace", fontSize: 18, lineHeight: 1.6, letterSpacing: '0.02em', color: C.line, marginTop: 4, fontWeight: 700 }}>{x.v}</div>,
                                  lineHeight: 1.6,
              </div>
            ))}
          </div>
        ...
        >
          ...
          <div style={{ fontFamily: "'Inter', system-ui, sans-serif", fontSize: 40, fontWeight: 700, color: C.line, marginTop: 18, textAlign: 'center' }}>
            Câu trả lời đã được ghi lại
          </div>
          <div style={{ fontFamily: "'Inter', system-ui, sans-serif", fontSize: 22, color: 'rgba(232,240,254,0.62)', marginTop: 8, textAlign: 'center', lineHeight: 1.5 }}>
            Hồ sơ của bạn sẽ được lưu và tự động điền khi mở lại biểu mẫu.
            <br />
            <span style={{ fontFamily: "'JetBrains Mono', monospace", fontSize: 19, lineHeight: 1.6, letterSpacing: '0.08em', color: C.cyan }}>forms.gle/8CFBumJ4PJxVryge6</span> đã xác nhận persistent.
          </div>
          <div style={{ display: 'flex', gap: 10, marginTop: 18 }}>
            <div style={{ fontFamily: "'JetBrains Mono', monospace", fontSize: 18, lineHeight: 1.6, letterSpacing: '0.12em', color: '#0A0F1E', background: C.hazard, padding: '7px 12px', fontWeight: 800 }}>✓ PERSISTENT</div>
            <div style={{ fontFamily: "'JetBrains Mono', monospace", fontSize: 18, lineHeight: 1.6, letterSpacing: '0.12em', color: C.line, border: '1px solid rgba(232,240,254,0.14)', padding: '7px 12px', background: 'rgba(232,240,254,0.06)' }}>GOOGLE FORMS · 200 OK</div>,
                              lineHeight: 1.6,
          </div>
          <div style={{ position: 'absolute', bottom: 14, left: 18, right: 18, height: 1, background: 'rgba(232,240,254,0.08)' }} />
          <div style={{ position: 'absolute', bottom: 6, left: 18, fontFamily: "'JetBrains Mono', monospace", fontSize: 15, lineHeight: 1.6, letterSpacing: '0.16em', color: 'rgba(124,141,166,0.5)' }}>
            MOCK UI · BLUEPRINT ACCURATE — KHÔNG DÙNG ẢNH CHỤP THẬT · TÁI DỰNG CHÍNH XÁC FIELD FLOW
          </div>
        </div>

        {/* bottom note */}
        <div style={{ fontFamily: "'JetBrains Mono', monospace", fontSize: 18, lineHeight: 1.6, letterSpacing: '0.12em', color: 'rgba(232,240,254,0.42)', textAlign: 'right' }}>
...
const Scene05: React.FC = () => {
  ...
  return (
    <AbsoluteFill style={{ background: C.ink }}>
      ...
      >
        <div style={{ display: 'flex', gap: 14, alignItems: 'center' }}>
          <div style={{ fontFamily: "'JetBrains Mono', monospace", fontSize: 19, lineHeight: 1.6, letterSpacing: '0.18em', color: '#0A0F1E', fontWeight: 900, background: C.hazard, padding: '4px 8px' }}>05 — CTA</div>
          <span style={{ fontFamily: "'Instrument Serif', serif", fontSize: 38, letterSpacing: '-0.02em', color: C.line }}>INSTALL · 3 COMMANDS</span>
        </div>
        <div style={{ fontFamily: "'JetBrains Mono', monospace", fontSize: 18, lineHeight: 1.6, letterSpacing: '0.16em', color: C.hazard, fontWeight: 700 }}>npx skills add — RUN NOW</div>
      </div>
      ...
      >
        ...
        <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'flex-start', gap: 18 }}>
          <div>
            <div style={{ fontFamily: "'JetBrains Mono', monospace", fontSize: 18, lineHeight: 1.6, letterSpacing: '0.22em', color: '#0A0F1E', fontWeight: 800 }}>▓ HARNESS 9.5 — BRUTALIST BLUEPRINT</div>
            <div style={{ fontFamily: "'Instrument Serif', serif", fontSize: 64, lineHeight: 1.05, letterSpacing: '-0.03em', color: '#0A0F1E', marginTop: 8 }}>
              Copy. Paste. <span style={{ textDecoration: 'underline', textDecorationThickness: 3, textUnderlineOffset: 6 }}>Ship.</span>
            </div>
          </div>
          <div style={{ background: '#0A0F1E', color: C.hazard, fontFamily: "'JetBrains Mono', monospace", fontSize: 18, letterSpacing: '0.14em', fontWeight: 800, padding: '8px 12px', textAlign: 'right', lineHeight: 1.4 }}>
            3 NEW SKILLS
            <br />
            851K + 508K + 214K
          </div>
        ...
        <div style={{ marginTop: 18, display: 'flex', flexDirection: 'column', gap: 10 }}>
          {[
            ...
            return (
              ...
              >
                <div style={{ fontFamily: "'JetBrains Mono', monospace", fontSize: 15, lineHeight: 1.6, letterSpacing: '0.16em', color: C.hazard, fontWeight: 800, background: 'rgba(255,214,10,0.12)', padding: '4px 7px', border: '1px solid rgba(255,214,10,0.28)', whiteSpace: 'nowrap' }}>
                  {c.label}
                </div>
                <code style={{ fontFamily: "'JetBrains Mono', monospace", fontSize: 22, lineHeight: 1.6, letterSpacing: '0.02em', color: C.line, fontWeight: 600, whiteSpace: 'nowrap' }}>{c.cmd}</code>
                <span style={{ marginLeft: 'auto', fontFamily: "'JetBrains Mono', monospace", fontSize: 18, lineHeight: 1.6, letterSpacing: '0.08em', color: 'rgba(232,240,254,0.42)', whiteSpace: 'nowrap' }}>{c.note}</span>
                <div style={{ width: 28, height: 28, background: C.hazard, display: 'flex', alignItems: 'center', justifyContent: 'center', flexShrink: 0 }}>
                  <span style={{ fontFamily: "'JetBrains Mono', monospace", fontSize: 22, lineHeight: 1.6, fontWeight: 900, color: '#0A0F1E' }}>↵</span>
                </div>
              </div>
            );
          })}
        ...
        <div style={{ marginTop: 14, display: 'flex', gap: 10, alignItems: 'center' }}>
          ...
          <span style={{ fontFamily: "'JetBrains Mono', monospace", fontSize: 15, lineHeight: 1.6, letterSpacing: '0.16em', color: '#0A0F1E', fontWeight: 800 }}>OR — `npx skills add` IN ANY PROJECT</span>
          <div style={{ flex: 1, height: 1, background: 'rgba(10,15,30,0.18)' }} />
        </div>
        <div style={{ marginTop: 10, display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
          <span style={{ fontFamily: "'JetBrains Mono', monospace", fontSize: 18, lineHeight: 1.6, letterSpacing: '0.12em', color: '#0A0F1E', fontWeight: 700 }}>RESTART OPENCODE TO LOAD · 1920×1080 · 64S · 5 SCENES</span>
          <span style={{ fontFamily: "'Instrument Serif', serif", fontSize: 28, letterSpacing: '-0.02em', color: '#0A0F1E', lineHeight: 1.6 }}>
      ...
      >
        <span style={{ fontFamily: "'JetBrains Mono', monospace", fontSize: 15, lineHeight: 1.6, letterSpacing: '0.18em', color: 'rgba(232,240,254,0.48)' }}>
