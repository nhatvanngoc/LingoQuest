...
export const GRADE_12_CURRICULUM: Grade12Unit[] = [
  {
    ...
    sections: [
      { id: "sec-1", title: "I. Getting Started", description: "A life story - Cuộc trò chuyện về những nhân vật vĩ đại truyền cảm hứng" },
      { id: "sec-2", title: "II. Language", description: "Phát âm trọng âm từ có 3 âm tiết; Ôn tập thì Quá khứ đơn & Quá khứ tiếp diễn" },
      { id: "sec-3", title: "III. Reading", description: "Đọc hiểu tiểu sử Chủ tịch Hồ Chí Minh và Steve Jobs" },
      { id: "sec-4", title: "IV. Speaking", description: "Thuyết trình về nhân vật truyền cảm hứng mà bạn ngưỡng mộ" },
      { id: "sec-5", title: "V. Listening", description: "Nghe bài phỏng vấn về hành trình vượt khó của một nhà khoa học trẻ" },
      { id: "sec-6", title: "VI. Writing", description: "Viết đoạn văn tiểu sử (biography) về một danh nhân thế giới" },
      { id: "sec-7", title: "VII. Communication & CLIL", description: "Giao tiếp xã hội và tìm hiểu danh nhân văn hóa Việt Nam" },
      { id: "sec-8", title: "VIII. Looking Back & Project", description: "Dự án: Triển lãm chân dung những con người làm thay đổi thế giới" }
    ],
    vocabulary: [
      {
        id: "v12-admirable",
        ...
        collocations: ["admirable effort", "admirable dedication", "admirable achievement"]
      },
      {
        id: "v12-biography",
        word: "biography",
        ...
        collocations: ["write a biography", "authorized biography", "biography of a leader"]
      },
      {
        id: "v12-perseverance",
        word: "perseverance",
        ...
        collocations: ["sheer perseverance", "demonstrate perseverance", "spirit of perseverance"]
      },
      {
        id: "v12-dedicated",
        word: "dedicated",
        ...
        collocations: ["dedicated to", "dedicated teacher", "dedicated staff"]
      },
      {
        ...
        collocations: ["revolutionary idea", "revolutionary movement", "revolutionary leader"]
      },
      {
        ...
        collocations: ["distinguished career", "distinguished guest", "distinguished scientist"]
      }
    ]
  },
  {
    ...
    sections: [
      { id: "sec-1", title: "I. Getting Started", description: "Cultural festival - Khám phá lễ hội giao lưu văn hóa quốc tế" },
      { id: "sec-2", title: "II. Language", description: "Ngữ điệu trong câu hỏi; Quy tắc sử dụng mạo từ A/An/The và Zero Article" },
      { id: "sec-3", title: "III. Reading", description: "Đọc hiểu về sự dung hòa văn hóa trong các đô thị đa sắc tộc" },
      { id: "sec-4", title: "IV. Speaking", description: "Thảo luận về phong tục tập quán và sự khác biệt văn hóa khi đi du học" },
      { id: "sec-5", title: "V. Listening", description: "Nghe về trải nghiệm hội nhập văn hóa của các bạn trẻ quốc tế" },
      { id: "sec-6", title: "VI. Writing", description: "Viết bài luận so sánh nét tương đồng và khác biệt giữa hai nền văn hóa" },
      { id: "sec-7", title: "VII. Communication & CLIL", description: "Bảo tồn bản sắc văn hóa dân tộc trong dòng chảy toàn cầu hóa" },
      { id: "sec-8", title: "VIII. Looking Back & Project", description: "Dự án: Ngày hội văn hóa quốc tế trường THPT" }
    ],
    vocabulary: [
      {
      ...
      },
      {
        ...
        collocations: ["cultural diversity", "biodiversity", "celebrate diversity"]
      },
      {
        id: "v12-assimilation",
        word: "assimilation",
        ...
        collocations: ["cultural assimilation", "process of assimilation", "social assimilation"]
      },
      {
        id: "v12-heritage",
        word: "heritage",
        ...
        collocations: ["cultural heritage", "world heritage site", "national heritage"]
      },
      {
        id: "v12-customary",
        word: "customary",
        ...
        collocations: ["customary practice", "it is customary to", "customary behavior"]
      }
    ]
  },
  {
    ...
    sections: [
      { id: "sec-1", title: "I. Getting Started", description: "Eco-habits - Thói quen giảm thiểu rác thải nhựa và dấu chân carbon" },
      { id: "sec-2", title: "II. Language", description: "Rút gọn mệnh đề bằng Phân từ hiện tại (V-ing) và Phân từ hoàn thành (Having + P2)" },
      { id: "sec-3", title: "III. Reading", description: "Bài đọc về mô hình kinh tế tuần hoàn (Circular Economy) và Net-Zero 2050" },
      { id: "sec-4", title: "IV. Speaking", description: "Thảo luận về các giải pháp tiêu dùng bền vững trong học đường" },
      { id: "sec-5", title: "V. Listening", description: "Nghe chuyên gia chia sẻ về giải pháp xử lý rác thải hữu cơ tại nhà" },
      { id: "sec-6", title: "VI. Writing", description: "Viết bài luận kêu gọi hành động vì môi trường học đường xanh sạch đẹp" },
      { id: "sec-7", title: "VII. Communication & CLIL", description: "Công nghệ năng lượng tái tạo và xu hướng thành phố carbon thấp" },
      { id: "sec-8", title: "VIII. Looking Back & Project", description: "Dự án: Chiến dịch Green School Challenge 30 ngày" }
    ],
    vocabulary: [
      {
        id: "v12-sustainable",
        ...
        collocations: ["sustainable lifestyle", "sustainable development", "sustainable materials"]
      },
      {
        ...
        collocations: ["reduce carbon footprint", "measure carbon footprint", "zero carbon footprint"]
      },
      {
        ...
        collocations: ["biodegradable waste", "biodegradable packaging", "biodegradable plastic"]
      },
      {
        ...
        collocations: ["transition to a circular economy", "principles of circular economy", "closed-loop circular economy"]
      },
      {
        id: "v12-compost",
        word: "compost",
        ...
        collocations: ["organic compost", "compost bin", "turn into compost"]
      }
    ]
  },
  {
    ...
    sections: [
      { id: "sec-1", title: "I. Language Review", description: "Luyện tập ngữ âm, từ vựng và ngữ pháp trọng tâm Units 1-3" },
      { id: "sec-2", title: "II. Skills Review", description: "Rèn luyện 4 kỹ năng Nghe - Nói - Đọc - Viết theo định dạng đề thi tốt nghiệp THPT mới" }
    ],
    vocabulary: []
  },
  {
    ...
    sections: [
      { id: "sec-1", title: "I. Getting Started", description: "City growth - Thực trạng dòng người di cư từ nông thôn ra thành thị" },
      { id: "sec-2", title: "II. Language", description: "Quy tắc cấu tạo Tính từ ghép (Compound Adjectives); phát âm nguyên âm đôi" },
      { id: "sec-3", title: "III. Reading", description: "Đọc hiểu về sự bùng nổ của các siêu đô thị (megacities) và bài toán giao thông" },
      { id: "sec-4", title: "IV. Speaking", description: "Tranh biện: Nên sống ở vùng nông thôn thanh bình hay thành phố tiện ích?" },
      { id: "sec-5", title: "V. Listening", description: "Nghe bài thuyết trình của chuyên gia quy hoạch đô thị về thành phố thông minh" },
      { id: "sec-6", title: "VI. Writing", description: "Viết biểu đồ phân tích xu hướng đô thị hóa tại khu vực Đông Nam Á" },
      { id: "sec-7", title: "VII. Communication & CLIL", description: "Ứng dụng IoT và AI trong điều hành giao thông công cộng đô thị" },
      { id: "sec-8", title: "VIII. Looking Back & Project", description: "Dự án: Thiết kế mô hình thành phố sinh thái tương lai (Eco-Smart City)" }
    ],
    vocabulary: [
      {
        id: "v12-urbanisation",
        ...
        collocations: ["rapid urbanisation", "pace of urbanisation", "urbanisation process"]
      },
      {
        ...
        collocations: ["densely-populated city", "densely-populated area", "densely-populated district"]
      },
      {
        ...
        collocations: ["transport infrastructure", "urban infrastructure", "upgrade infrastructure"]
      },
      {
        id: "v12-overcrowded",
        word: "overcrowded",
        ...
        collocations: ["overcrowded streets", "severely overcrowded", "overcrowded living conditions"]
      },
      {
        id: "v12-megacity",
        word: "megacity",
        ...
        collocations: ["global megacity", "growth of megacities", "manage a megacity"]
      }
    ]
  },
  {
    ...
    sections: [
      { id: "sec-1", title: "I. Getting Started", description: "Future careers - Cuộc thảo luận về chọn ngành nghề và yêu cầu thị trường việc làm" },
      { id: "sec-2", title: "II. Language", description: "Luyện tập Mệnh đề quan hệ xác định và không xác định; ngữ điệu câu hỏi phức" },
      { id: "sec-3", title: "III. Reading", description: "Đọc hiểu về các kỹ năng thế kỷ 21 mà nhà tuyển dụng toàn cầu tìm kiếm" },
      { id: "sec-4", title: "IV. Speaking", description: "Thực hành phỏng vấn xin việc (Job Interview Roleplay) theo tiêu chuẩn chuyên nghiệp" },
      { id: "sec-5", title: "V. Listening", description: "Nghe tư vấn từ chuyên gia nhân sự về cách viết CV và Portfolio thu hút" },
      { id: "sec-6", title: "VI. Writing", description: "Viết thư ứng tuyển (Cover Letter) xin học bổng hoặc vị trí thực tập sinh" },
      { id: "sec-7", title: "VII. Communication & CLIL", description: "Xu hướng làm việc từ xa (Remote Work) và nền kinh tế Gig toàn cầu" },
      { id: "sec-8", title: "VIII. Looking Back & Project", description: "Dự án: Ngày hội hướng nghiệp Career Fair dành cho học sinh THPT" }
    ],
    vocabulary: [
      {
        id: "v12-adaptability",
        ...
        collocations: ["show adaptability", "high adaptability", "adaptability to change"]
      },
      {
        id: "v12-competence",
        word: "competence",
        ...
        collocations: ["professional competence", "linguistic competence", "core competence"]
      },
      {
        id: "v12-internship",
        word: "internship",
        ...
        collocations: ["summer internship", "paid internship", "land an internship"]
      },
      {
        ...
        collocations: ["formal qualifications", "academic qualifications", "gain qualifications"]
      },
      {
        id: "v12-workplace",
        word: "workplace",
        ...
        collocations: ["workplace culture", "in the workplace", "modern workplace"]
      }
    ]
  },
  {
    ...
    sections: [
      { id: "sec-1", title: "I. Language Review", description: "Luyện đề tổng hợp từ vựng và ngữ pháp toàn học kỳ 1" },
      { id: "sec-2", title: "II. Skills Review", description: "Luyện thi thử 4 kỹ năng theo cấu trúc chuẩn khảo thí quốc gia" }
    ],
    vocabulary: []
  },
  {
    ...
    sections: [
      { id: "sec-1", title: "I. Getting Started", description: "AI in daily life - Trợ lý ảo, xe tự hành và công cụ xử lý ngôn ngữ tự nhiên" },
      { id: "sec-2", title: "II. Language", description: "Ngữ pháp Thể truyền khiến chủ động và bị động; ngữ điệu câu bình luận" },
      { id: "sec-3", title: "III. Reading", description: "Đọc hiểu về tác động của Generative AI và vấn đề đạo đức trí tuệ nhân tạo" },
      { id: "sec-4", title: "IV. Speaking", description: "Tranh biện: Liệu AI có thay thế hoàn toàn người lao động trong tương lai?" },
      { id: "sec-5", title: "V. Listening", description: "Nghe nhà khoa học công nghệ giải thích về mạng nơ-ron và Deep Learning" },
      { id: "sec-6", title: "VI. Writing", description: "Viết bài văn nghị luận (opinion essay) về mặt lợi và hại của AI trong giáo dục" },
      { id: "sec-7", title: "VII. Communication & CLIL", description: "Ứng dụng thuật toán AI trong chẩn đoán y khoa và dự báo thiên tai" },
      { id: "sec-8", title: "VIII. Looking Back & Project", description: "Dự án: Đề xuất ý tưởng ứng dụng AI giải quyết vấn đề tại địa phương" }
    ],
    vocabulary: [
      {
        ...
        collocations: ["generative artificial intelligence", "ethics in artificial intelligence", "deploy artificial intelligence"]
      },
      {
        id: "v12-automation",
        word: "automation",
        ...
        collocations: ["workplace automation", "full automation", "automation technology"]
      },
      {
        id: "v12-algorithm",
        word: "algorithm",
        ...
        collocations: ["search algorithm", "machine learning algorithm", "algorithmic bias"]
      },
      {
        id: "v12-breakthrough",
        word: "breakthrough",
        ...
        collocations: ["major breakthrough", "technological breakthrough", "make a breakthrough"]
      },
      {
        id: "v12-autonomous",
        word: "autonomous",
        ...
        collocations: ["autonomous vehicles", "autonomous system", "autonomous decision-making"]
      }
    ]
  },
  {
    ...
    sections: [
      { id: "sec-1", title: "I. Getting Started", description: "Media consumption - Thói quen tiếp nhận tin tức và truyền thông số của giới trẻ" },
      { id: "sec-2", title: "II. Language", description: "Giới từ sau động từ và tính từ; ngữ điệu thể hiện thái độ hoài nghi hoặc đồng tình" },
      { id: "sec-3", title: "III. Reading", description: "Đọc hiểu về kỹ năng nhận diện tin giả (Fake News) và kiểm chứng nguồn tin số" },
      { id: "sec-4", title: "IV. Speaking", description: "Thảo luận về ảnh hưởng tâm lý của mạng xã hội đối với thanh thiếu niên" },
      { id: "sec-5", title: "V. Listening", description: "Nghe podcast chia sẻ từ một nhà báo điều tra về đạo đức nghề báo" },
      { id: "sec-6", title: "VI. Writing", description: "Viết bài đánh giá (review) một kênh tin tức trực tuyến hoặc podcast giáo dục" },
      { id: "sec-7", title: "VII. Communication & CLIL", description: "Quyền sở hữu trí tuệ và bản quyền nội dung số trên Internet" },
      { id: "sec-8", title: "VIII. Looking Back & Project", description: "Dự án: Xuất bản bản tin đa phương tiện của trường học" }
    ],
    vocabulary: [
      {
        id: "v12-mass-media",
        ...
        collocations: ["influence of mass media", "modern mass media", "mass media coverage"]
      },
      {
        ...
        collocations: ["enhance digital literacy", "digital literacy curriculum", "digital literacy skills"]
      },
      {
        ...
        collocations: ["combat misinformation", "spread misinformation", "counter misinformation"]
      },
      {
        id: "v12-credibility",
        word: "credibility",
        ...
        collocations: ["source credibility", "establish credibility", "lose credibility"]
      },
      {
        ...
        collocations: ["media sensationalism", "avoid sensationalism", "tabloid sensationalism"]
      }
    ]
  },
  {
    ...
    sections: [
      { id: "sec-1", title: "I. Getting Started", description: "Saving species - Khám phá các chiến dịch cứu hộ động vật hoang dã tại Việt Nam" },
      { id: "sec-2", title: "II. Language", description: "Câu phức chứa mệnh đề trạng ngữ chỉ điều kiện, nhượng bộ và kết quả" },
      { id: "sec-3", title: "III. Reading", description: "Đọc hiểu về nỗ lực cứu vãn loài Voọc mông trắng tại Vườn Quốc gia Cúc Phương" },
      { id: "sec-4", title: "IV. Speaking", description: "Thuyết trình về hậu quả nghiêm trọng của việc săn bắt và buôn bán trái phép thú quý hiếm" },
      { id: "sec-5", title: "V. Listening", description: "Nghe các nhà kiểm lâm chia sẻ về công tác tuần tra rừng ngập mặn" },
      { id: "sec-6", title: "VI. Writing", description: "Viết thư kiến nghị gửi cơ quan chức năng đề xuất biện pháp bảo vệ động vật nguy cấp" },
      { id: "sec-7", title: "VII. Communication & CLIL", description: "Công ước CITES và hành lang pháp lý quốc tế về bảo tồn sinh học" },
      { id: "sec-8", title: "VIII. Looking Back & Project", description: "Dự án: Chiến dịch gây quỹ hỗ trợ trung tâm cứu hộ động vật hoang dã" }
    ],
    vocabulary: [
      {
        id: "v12-conservation",
        ...
        collocations: ["wildlife conservation", "conservation effort", "conservation area"]
      },
      {
        id: "v12-poaching",
        word: "poaching",
        ...
        collocations: ["illegal poaching", "combat poaching", "anti-poaching patrol"]
      },
      {
        id: "v12-habitat-loss",
        word: "habitat loss",
        ...
        collocations: ["cause habitat loss", "suffer habitat loss", "prevent habitat loss"]
      },
      {
        id: "v12-biodiversity",
        word: "biodiversity",
        ...
        collocations: ["preserve biodiversity", "threat to biodiversity", "biodiversity hotspot"]
      },
      {
        id: "v12-extinction",
        word: "extinction",
        ...
        collocations: ["brink of extinction", "mass extinction", "driven to extinction"]
      }
    ]
  },
  {
    ...
    sections: [
      { id: "sec-1", title: "I. Language Review", description: "Hệ thống hóa cấu trúc ngữ pháp và từ vựng chuyên ngành AI, Truyền thông & Sinh thái" },
      { id: "sec-2", title: "II. Skills Review", description: "Luyện bài đọc hiểu dài và bài viết học thuật chuẩn đầu ra THPT" }
    ],
    vocabulary: []
  },
  {
    ...
    sections: [
      { id: "sec-1", title: "I. Getting Started", description: "Choosing a pathway - Đại học hay trường nghề? Định hướng tương lai" },
      { id: "sec-2", title: "II. Language", description: "Trọng âm trong cụm động từ; cách dùng cụm động từ nâng cao có giới từ kép" },
      { id: "sec-3", title: "III. Reading", description: "Đọc hiểu về lợi thế thực tiễn của chương trình học nghề và học nghề vừa học vừa làm (Apprenticeship)" },
      { id: "sec-4", title: "IV. Speaking", description: "Tư vấn lộ trình sự nghiệp phù hợp với sở thích, đam mê và tính cách cá nhân" },
      { id: "sec-5", title: "V. Listening", description: "Nghe chia sẻ thành công từ một kỹ sư phần mềm xuất phát điểm từ trường cao đẳng nghề" },
      { id: "sec-6", title: "VI. Writing", description: "Viết bài luận phân tích ưu nhược điểm giữa con đường học thuật và đào tạo nghề" },
      { id: "sec-7", title: "VII. Communication & CLIL", description: "Tiêu chuẩn kỹ năng nghề quốc tế và tính dịch chuyển lao động trong ASEAN" },
      { id: "sec-8", title: "VIII. Looking Back & Project", description: "Dự án: Bản đồ định hướng lộ trình nghề nghiệp 5 năm (Career Roadmap)" }
    ],
    vocabulary: [
      {
        id: "v12-career-path",
        ...
        collocations: ["pursue a career path", "choose a career path", "clear career path"]
      },
      {
        ...
        collocations: ["serve an apprenticeship", "vocational apprenticeship", "paid apprenticeship"]
      },
      {
        id: "v12-vocational",
        word: "vocational",
      ...
      },
      {
        ...
        collocations: ["foster entrepreneurship", "spirit of entrepreneurship", "social entrepreneurship"]
      },
      {
        id: "v12-hands-on",
        word: "hands-on",
        ...
        collocations: ["hands-on experience", "hands-on training", "hands-on approach"]
      }
    ]
  },
  {
    ...
    sections: [
      { id: "sec-1", title: "I. Getting Started", description: "Learning never stops - Khám phá khái niệm học tập suốt đời trong kỷ nguyên AI" },
      { id: "sec-2", title: "II. Language", description: "Đảo ngữ với trạng từ phủ định và hạn chế; ngữ điệu câu đảo ngữ mang tính kịch tính" },
      { id: "sec-3", title: "III. Reading", description: "Đọc hiểu về tư duy phát triển (Growth Mindset) và các nền tảng MOOC trực tuyến" },
      { id: "sec-4", title: "IV. Speaking", description: "Thảo luận về cách tự học hiệu quả một kỹ năng mới trong vòng 30 ngày" },
      { id: "sec-5", title: "V. Listening", description: "Nghe bài phỏng vấn cụ bà 80 tuổi vừa xuất sắc nhận bằng cử nhân đại học" },
      { id: "sec-6", title: "VI. Writing", description: "Viết bài luận thuyết phục: Tại sao học tập suốt đời là chìa khóa thành công bền vững?" },
      { id: "sec-7", title: "VII. Communication & CLIL", description: "Xây dựng xã hội học tập (Learning Society) theo tiêu chuẩn UNESCO" },
      { id: "sec-8", title: "VIII. Looking Back & Project", description: "Dự án: Lập kế hoạch tự học suốt đời cho giai đoạn 10 năm tới" }
    ],
    vocabulary: [
      {
        ...
        collocations: ["embrace lifelong learning", "lifelong learning skills", "commitment to lifelong learning"]
      },
      {
        ...
        collocations: ["cultivate a growth mindset", "adopt a growth mindset", "fixed versus growth mindset"]
      },
      {
        ...
        collocations: ["self-directed learning", "self-directed study", "self-directed learner"]
      },
      {
        id: "v12-upskilling",
        word: "upskilling",
        ...
        collocations: ["reskilling and upskilling", "upskilling programs", "need for upskilling"]
      },
      {
        id: "v12-inquisitive",
        word: "inquisitive",
        ...
        collocations: ["inquisitive mind", "stay inquisitive", "naturally inquisitive"]
      }
    ]
  },
  {
    ...
    sections: [
      { id: "sec-1", title: "I. Comprehensive Language Review", description: "Tổng hợp toàn bộ ngữ âm, từ vựng và cấu trúc ngữ pháp then chốt 3 năm THPT" },
      { id: "sec-2", title: "II. Exam Practice Test", description: "Bộ đề luyện thi thử tốt nghiệp THPT chuẩn cấu trúc phân hóa của Bộ Giáo dục và Đào tạo" }
    ],
    vocabulary: []
  }
];
