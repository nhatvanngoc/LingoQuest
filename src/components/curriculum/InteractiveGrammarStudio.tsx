    ...
    <div className="space-y-6">
      ...
      <div className="relative overflow-hidden rounded-3xl border border-amber-200/90 bg-gradient-to-br from-amber-50/80 via-white to-amber-50/40 p-6 sm:p-8 shadow-xs">
        <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-4">
          <div>
            <div className="inline-flex items-center gap-2 rounded-full bg-amber-100/80 px-3 py-1 text-xs font-bold text-amber-800 border border-amber-200">
          ...
          <div className="flex flex-wrap items-center rounded-2xl bg-slate-100/90 p-1.5 border border-slate-200/70 shrink-0">
            <button
      ...
      <div className="rounded-3xl border border-slate-200/80 bg-white p-6 sm:p-8 shadow-xs">
        ...
        <div className="relative py-6">
          <div className="h-2 w-full bg-slate-100 rounded-full relative">
            <div className="absolute left-0 top-1/2 -translate-y-1/2 h-1.5 w-1/3 bg-blue-500 rounded-l-full" />
            <div className="absolute left-1/3 top-1/2 -translate-y-1/2 h-2 w-1/3 bg-gradient-to-r from-blue-500 via-indigo-500 to-purple-600" />
            <div className="absolute right-0 top-1/2 -translate-y-1/2 h-1.5 w-1/3 bg-slate-200 rounded-r-full" />

            {/* Marker 1: Past Simple Stop Point */}
            <div className="absolute left-[18%] top-1/2 -translate-y-1/2 flex flex-col items-center">
              <div className="h-5 w-5 rounded-full bg-blue-600 border-4 border-white shadow-md flex items-center justify-center text-[9px] text-white font-black">
                ⏹
              </div>
              <div className="absolute top-6 whitespace-nowrap text-center">
                <span className="block font-bold text-xs text-blue-700">Quá khứ đơn</span>
                <span className="block text-[10px] text-slate-400 font-medium">Chấm dứt hoàn toàn</span>
              </div>
            </div>

            {/* Marker 2: Present Perfect Bridge Arrow */}
            <div className="absolute left-[50%] top-1/2 -translate-y-1/2 flex flex-col items-center">
              <div className="h-6 w-6 rounded-full bg-gradient-to-br from-indigo-500 to-purple-600 border-4 border-white shadow-lg flex items-center justify-center text-[10px] text-white font-black animate-pulse">
                🔗
              </div>
              <div className="absolute top-6 whitespace-nowrap text-center">
                <span className="block font-bold text-xs text-purple-700">Hiện tại hoàn thành</span>
                <span className="block text-[10px] text-slate-400 font-medium">Kéo dài đến Hiện tại</span>
              </div>
            </div>

            {/* Marker 3: Present Moment */}
            <div className="absolute left-[66.6%] top-1/2 -translate-y-1/2 flex flex-col items-center">
              <div className="h-4 w-4 rounded-full bg-slate-900 border-2 border-white shadow-sm" />
              <div className="absolute top-6 whitespace-nowrap text-center">
                <span className="block font-bold text-xs text-slate-900">NOW</span>
                <span className="block text-[10px] text-slate-400 font-medium">Hiện tại</span>
              </div>
            </div>
          </div>
        </div>

        <div className="mt-12 pt-4 border-t border-slate-100 grid grid-cols-1 sm:grid-cols-2 gap-4 text-xs">
          <div className="rounded-2xl bg-blue-50/60 border border-blue-100 p-3.5">
            <span className="font-bold text-blue-900 block mb-1">🟦 Quá khứ đơn (Past Simple):</span>
          ...
          <div className="rounded-2xl bg-purple-50/60 border border-purple-100 p-3.5">
            <span className="font-bold text-purple-900 block mb-1">🟪 Hiện tại hoàn thành (Present Perfect):</span>
      ...
      {grammarView === "comparison" && (
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          ...
          <div className="rounded-3xl border border-blue-200 bg-white p-6 sm:p-7 shadow-xs hover:border-blue-300 transition-all flex flex-col justify-between">
            <div>
              <div className="flex items-center justify-between mb-3">
                <span className="rounded-full bg-blue-100 text-blue-800 px-3 py-1 text-xs font-black">
                  PAST SIMPLE (Quá khứ đơn)
                </span>
                <span className="text-xs font-mono font-bold text-blue-600">S + V2/ed</span>
              </div>
              ...
              <ul className="space-y-3 text-xs text-slate-700 leading-relaxed">
                <li className="flex items-start gap-2">
                  <span className="h-5 w-5 rounded-lg bg-blue-50 text-blue-600 flex items-center justify-center font-bold shrink-0">1</span>
                  <span><strong>Sự việc đã dứt điểm:</strong> Diễn ra và chấm dứt tại thời điểm cụ thể trong quá khứ.</span>
                </li>
                <li className="flex items-start gap-2">
                  <span className="h-5 w-5 rounded-lg bg-blue-50 text-blue-600 flex items-center justify-center font-bold shrink-0">2</span>
                  <span><strong>Chuỗi hành động liên tiếp:</strong> Kể lại các sự việc nối tiếp nhau trong quá khứ (kể chuyện).</span>
                </li>
                <li className="flex items-start gap-2">
                  <span className="h-5 w-5 rounded-lg bg-blue-50 text-blue-600 flex items-center justify-center font-bold shrink-0">3</span>
              ...
              <div className="mt-5 pt-4 border-t border-slate-100 space-y-2">
                ...
                <div className="rounded-xl bg-slate-50 p-3 flex items-start justify-between gap-2 border border-slate-100">
                  <div>
                    ...
                    <p className="text-[11px] text-slate-500 mt-0.5">→ Chúng tôi từng sống ở Hà Nội khi tôi còn nhỏ (giờ không sống ở đó nữa).</p>
                  </div>
                  <button
                    onClick={() => playSentenceAudio("We lived in Ha Noi when I was little.")}
                    className="p-1.5 rounded-lg bg-white text-blue-600 hover:bg-blue-100 transition-colors shadow-2xs shrink-0 cursor-pointer"
                  >
            ...
            <div className="mt-5 pt-4 border-t border-slate-100">
              <span className="text-[11px] font-bold text-slate-400 uppercase block mb-1.5">Dấu hiệu nhận biết:</span>
              <div className="flex flex-wrap gap-1.5">
                {["yesterday", "ago", "last week", "last year", "in 2019", "when I was young"].map((tag, idx) => (
                  <span key={idx} className="rounded-lg bg-blue-50 text-blue-700 px-2.5 py-1 text-[11px] font-semibold border border-blue-100">
                    {tag}
                  </span>
                ))}
              </div>
          ...
          <div className="rounded-3xl border border-purple-200 bg-white p-6 sm:p-7 shadow-xs hover:border-purple-300 transition-all flex flex-col justify-between">
            <div>
              <div className="flex items-center justify-between mb-3">
                <span className="rounded-full bg-purple-100 text-purple-800 px-3 py-1 text-xs font-black">
                  PRESENT PERFECT (Hiện tại hoàn thành)
                </span>
                <span className="text-xs font-mono font-bold text-purple-600">S + have/has + V3/ed</span>
              </div>
              ...
              <ul className="space-y-3 text-xs text-slate-700 leading-relaxed">
                <li className="flex items-start gap-2">
                  <span className="h-5 w-5 rounded-lg bg-purple-50 text-purple-600 flex items-center justify-center font-bold shrink-0">1</span>
                  <span><strong>Hành động kéo dài đến hiện tại:</strong> Bắt đầu trong quá khứ và vẫn đang tiếp diễn.</span>
                </li>
                <li className="flex items-start gap-2">
                  <span className="h-5 w-5 rounded-lg bg-purple-50 text-purple-600 flex items-center justify-center font-bold shrink-0">2</span>
                  <span><strong>Vừa mới xảy ra:</strong> Hành động xảy ra rất gần, có kết quả rõ ràng ở hiện tại.</span>
                </li>
                <li className="flex items-start gap-2">
                  <span className="h-5 w-5 rounded-lg bg-purple-50 text-purple-600 flex items-center justify-center font-bold shrink-0">3</span>
              ...
              <div className="mt-5 pt-4 border-t border-slate-100 space-y-2">
                ...
                <div className="rounded-xl bg-slate-50 p-3 flex items-start justify-between gap-2 border border-slate-100">
                  <div>
                    ...
                    <p className="text-[11px] text-slate-500 mt-0.5">→ Chúng tôi đã sống ở Hà Nội được 10 năm (và hiện tại vẫn đang sống ở đây).</p>
                  </div>
                  <button
                    onClick={() => playSentenceAudio("We have lived in Ha Noi for ten years.")}
                    className="p-1.5 rounded-lg bg-white text-purple-600 hover:bg-purple-100 transition-colors shadow-2xs shrink-0 cursor-pointer"
                  >
                    <Volume2 className="h-4 w-4" />
                  </button>
                </div>
            ...
            <div className="mt-5 pt-4 border-t border-slate-100">
              ...
              <div className="flex flex-wrap gap-1.5">
                {["since + mốc", "for + khoảng", "already", "yet", "just", "ever / never", "so far", "recently"].map((tag, idx) => (
                  <span key={idx} className="rounded-lg bg-purple-50 text-purple-700 px-2.5 py-1 text-[11px] font-semibold border border-purple-100">
                    {tag}
                  </span>
                ))}
              </div>
      ...
      {grammarView === "formulas" && (
        <div className="space-y-6">
          ...
          <div className="rounded-3xl border border-blue-200 bg-white p-6 shadow-xs space-y-4">
            <h3 className="font-heading text-base font-bold text-blue-900 flex items-center gap-2">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-3 text-xs">
              <div className="rounded-2xl bg-blue-50/50 p-4 border border-blue-100">
                <span className="font-extrabold text-blue-700 block mb-1.5">(+) Thể Khẳng định:</span>
                <div className="font-mono font-bold text-slate-900 text-sm bg-white p-2.5 rounded-xl border border-blue-100">
                  S + V2 / V-ed
                </div>
                <p className="text-slate-500 mt-2 italic">&quot;They worked out yesterday.&quot;</p>
              </div>

              <div className="rounded-2xl bg-blue-50/50 p-4 border border-blue-100">
                <span className="font-extrabold text-blue-700 block mb-1.5">(-) Thể Phủ định:</span>
                <div className="font-mono font-bold text-slate-900 text-sm bg-white p-2.5 rounded-xl border border-blue-100">
                  S + did not (didn&apos;t) + V-inf
                </div>
                <p className="text-slate-500 mt-2 italic">&quot;They didn&apos;t work out.&quot;</p>
              </div>

              <div className="rounded-2xl bg-blue-50/50 p-4 border border-blue-100">
                <span className="font-extrabold text-blue-700 block mb-1.5">(?) Thể Nghi vấn:</span>
                <div className="font-mono font-bold text-slate-900 text-sm bg-white p-2.5 rounded-xl border border-blue-100">
                  Did + S + V-inf ?
                </div>
                <p className="text-slate-500 mt-2 italic">&quot;Did they work out?&quot;</p>
              </div>
            </div>
          </div>

          {/* Present Perfect Formulas */}
          <div className="rounded-3xl border border-purple-200 bg-white p-6 shadow-xs space-y-4">
            <h3 className="font-heading text-base font-bold text-purple-900 flex items-center gap-2">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-3 text-xs">
              <div className="rounded-2xl bg-purple-50/50 p-4 border border-purple-100">
                <span className="font-extrabold text-purple-700 block mb-1.5">(+) Thể Khẳng định:</span>
                <div className="font-mono font-bold text-slate-900 text-sm bg-white p-2.5 rounded-xl border border-purple-100">
                  S + have / has + V3 / V-ed
                </div>
                <p className="text-slate-500 mt-2 italic">&quot;I have taken antibiotics.&quot;</p>
              </div>

              <div className="rounded-2xl bg-purple-50/50 p-4 border border-purple-100">
                <span className="font-extrabold text-purple-700 block mb-1.5">(-) Thể Phủ định:</span>
                <div className="font-mono font-bold text-slate-900 text-sm bg-white p-2.5 rounded-xl border border-purple-100">
                  S + haven&apos;t / hasn&apos;t + V3 / V-ed
                </div>
                <p className="text-slate-500 mt-2 italic">&quot;I haven&apos;t taken antibiotics.&quot;</p>
              </div>

              <div className="rounded-2xl bg-purple-50/50 p-4 border border-purple-100">
                <span className="font-extrabold text-purple-700 block mb-1.5">(?) Thể Nghi vấn:</span>
                <div className="font-mono font-bold text-slate-900 text-sm bg-white p-2.5 rounded-xl border border-purple-100">
                  Have / Has + S + V3 / V-ed ?
                </div>
                <p className="text-slate-500 mt-2 italic">&quot;Have you taken antibiotics?&quot;</p>
              </div>
            </div>
          </div>
        </div>
      ...
      {grammarView === "signals" && (
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          <div className="rounded-3xl border border-slate-200/80 bg-white p-6 shadow-xs space-y-4">
            ...
            <div className="space-y-3 text-xs">
              <div className="rounded-2xl bg-slate-50 p-3.5 border border-slate-100">
                <span className="font-bold text-blue-700 block mb-1">Quy tắc 1: Có mốc thời gian rõ ràng</span>
              ...
              <div className="rounded-2xl bg-slate-50 p-3.5 border border-slate-100">
                <span className="font-bold text-blue-700 block mb-1">Quy tắc 2: Khi vế câu có &quot;When + Quá khứ&quot;</span>
                <p className="text-slate-600">
          ...
          <div className="rounded-3xl border border-slate-200/80 bg-white p-6 shadow-xs space-y-4">
            ...
            <div className="space-y-3 text-xs">
              <div className="rounded-2xl bg-slate-50 p-3.5 border border-slate-100">
                <span className="font-bold text-purple-700 block mb-1">Quy tắc 1: Cặp đôi SINCE và FOR</span>
                <p className="text-slate-600">
              ...
              <div className="rounded-2xl bg-slate-50 p-3.5 border border-slate-100">
                <span className="font-bold text-purple-700 block mb-1">Quy tắc 2: Từ chỉ kinh nghiệm &amp; trạng thái</span>
                <p className="text-slate-600">
        ...
        <div className="rounded-3xl border border-slate-200/80 bg-white p-6 sm:p-8 shadow-xs space-y-6">
          ...
          <div className="space-y-4">
            {miniCheckQuestions.map((item, qIdx) => {
              ...
              return (
                <div key={qIdx} className="rounded-2xl border border-slate-200/90 bg-slate-50/50 p-4">
                  <p className="font-heading text-sm font-bold text-slate-900 mb-3">{item.q}</p>
                    ...
                    {item.options.map((opt, optIdx) => {
                      ...
                      return (
                        <button
                          ...
                          className={`text-left rounded-xl border p-3 text-xs transition-all flex items-center justify-between cursor-pointer ${style}`}
                        >
                          <span>{opt}</span>
                          {checkedResults && isCorrect && <CheckCircle2 className="h-4 w-4 text-emerald-600 shrink-0" />}
                        </button>
                      );
                    })}
                  </div>
                  ...
                  {checkedResults && (
                    <div className="mt-3 rounded-xl bg-indigo-50/80 p-2.5 text-xs text-indigo-900 border border-indigo-100">
                      <strong>💡 Lời giải thích: </strong> {item.hint}
                    </div>
                  )}
                </div>
              );
          ...
          <div className="flex items-center justify-between pt-2">
            {!checkedResults ? (
              ...
              >
                <RotateCcw className="mr-1.5 h-3.5 w-3.5" /> Thử sức lại
              </Button>
            )}
          </div>
        </div>
